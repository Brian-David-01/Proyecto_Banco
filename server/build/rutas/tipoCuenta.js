...
class TipoCuentaRoutes {
    ...
    config() {
        ...
        this.router.put('/:numCuenta', tipoCuentaController_1.default.actualiza);
        this.router.delete('/:numCuenta', tipoCuentaController_1.default.elimina);
        this.router.get('/:numCuenta', tipoCuentaController_1.default.buscar);
    }
}
